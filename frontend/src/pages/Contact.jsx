            ...
            <div className="bg-white shadow-lg rounded-lg p-6 md:w-1/2">
              ...
              <div class="flex items-center gap-2">
                <svg fill="#000000" width="40px" height="40px" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                  <path d="M49,18.92A23.74,23.74,0,0,0,25.27,42.77c0,16.48,17,31.59,22.23,35.59a2.45,2.45,0,0,0,3.12,0c5.24-4.12,
                    22.1-19.11,22.1-35.59A23.74,23.74,0,0,0,49,18.92Zm0,33.71a10,10,0,1,1,10-10A10,10,0,0,1,49,52.63Z"/>
                </svg>
                <span class="text-gray-700">4000 Victoria Park Ave, North York, ON M2H 3S7</span>
              </div>
              <div class="flex items-center gap-2">
                <svg width="35px" height="35px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M4 7L10.94 11.3375C11.5885 11.7428 12.4115 11.7428 13.06 11.3375L20 7M5 18H19C20.1046 18 21 17.1046 21 
                    16V8C21 6.89543 20.1046 6 19 6H5C3.89543 6 3 6.89543 3 8V16C3 17.1046 3.89543 18 5 18Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                <span class="text-gray-700">trafficpulse.simulation@gmail.com</span>
              </div>
