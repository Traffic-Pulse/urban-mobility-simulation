    ...
    <nav className="fixed top-0 inset-x-0 z-50 text-white bg-[#fff7ec] font-medium shadow-md py-2">
        <div className="flex mx-auto items-center ltr">
            ...
            <ul className="ml-auto text-base text-white flex justify-between me-2">
                <li>
                    <NavLink className="md:p-4 py-2 block text-[#2f3b52] hover:text-red-800" to="/">Home</NavLink>
                </li>
                <li>
                    <NavLink className="md:p-4 py-2 block text-[#2f3b52] hover:text-purple-400" to="/contact">Contact</NavLink>
                </li>
                <li>
                    <NavLink className="md:p-4 py-2 block text-[#2f3b52] hover:text-purple-400" to="/policies">Policies</NavLink>
                </li>
            </ul>
        </div>
    </nav>
